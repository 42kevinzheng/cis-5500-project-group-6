# cis-5500-project-group-6
Group 6 Project CIS-5500

**Project Motivation and Description**
Although music streaming platforms provide access to millions of songs, they often limit users to localized charts and recommendations. As a result, it’s difficult for listeners, artists, and researchers to easily compare music trends across countries and genres in one place.
...
**Installation 
Download server folder and install using (npm i)
